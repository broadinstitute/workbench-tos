 ...
 * @param {*} errorOrMessage can be either an Error object (preferably a ResponseError)
 *    whose message and cause will be reused, or a message to marshal into a ResponseError.
 */
